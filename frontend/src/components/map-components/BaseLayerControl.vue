<template>
    <div>
        <select
            class="form-select block w-full mt-1 rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0"
...
export default {
    ...
    computed: {
        ...
        selectedBaseLayer: {
            ...
            set(newValue) {
                this.setBaseLayerVisibility(newValue);
            },
        },
    },    
};
